...
<div class="container col-md-10">
        <div class="card">
            ...
            <h1 style="color:black;">Data Pemenang</h1>
            <div class="card-body">
            <table class="table">
                <thead>
                    <tr>
...
<br> <center><input type="button" value="print" onclick="printDiv()"> </center>
</body>
</html>
            <!-- Blank End -->
